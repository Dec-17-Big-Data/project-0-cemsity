...
public class AccountService {
	...
	public boolean withdraw(Account account, Integer ammount) {
		boolean worked = accountDao.withdraw(account, ammount);
		return worked;
	}
	public boolean transfer(Account account1,Account account2, Integer ammount) {
		boolean worked = accountDao.transfer(account1, account2, ammount);
		return worked;
	}
